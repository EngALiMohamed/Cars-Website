        ...
        <div className="flex flex-col md:flex-row xl:items-center">
          <div className="flex-1 xl:ml-24 text-center md:text-left mb-12 md:mb-0">
            <div className="max-w-[520px] mx-auto order-2 xl:order-none ">
              ...
              className="h2"
              >Download our App now and hit the road with ease</motion.h2>
                <motion.p
                variants={fadIn('right',0.4)}
                initial='hidden' whileInView={'show'} viewport={{once:false ,amount:0.4}}
                className="mb-10">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste 
                cupiditate ducimus beatae qui nam vero illum accusamus, ipsam officiis magni.
                </motion.p>
                {/* btns */} 
                <motion.div 
                variants={fadIn('right',0.4)}
                ...
                <Image src={'/icons/buttons/google-play.svg'} width={132} height=
                {36}alt="" />
                </button>
                <button className='btn-cta'>
                <Image src='/icons/buttons/app-store.svg' width={132} height=
                {36} alt=""/>
                </button>
                </motion.div>
