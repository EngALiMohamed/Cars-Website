...
interface HeroProps {} // Define an interface for potential props
    ...
    <section className="h-screen xl:h-[90vh] bg-[#b2b7c2]/10" id="home">
      <div className="container mx-auto h-full xl:pt-10">
        ...
        >
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.6 }}
            className="relative w-full h-full max-w-[50vh] md:max-w-[70vw] xl:max-w-[860px] xl:max-h-[542px] xl:absolute xl:-right-[-100px] min-[1680px] :right-[120px] xl:top-48px"
          >
      ...
      {searchActive ? (
        ...
        <div className="xl:mt-[-40px] w-full max-w-[1300px] mx-auto">
          <motion.div variants={fadIn("up", 0.8)} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0.2 }}>
            <Search />
          </motion.div>
        </div>
      )}
