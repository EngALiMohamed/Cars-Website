                ...
                className="max-w-[385px] mx-auto sm:mx-0 ">
                  ...
                  <div className="flex justify-between ">
                    <div className="">
                      ...
                      <h3 className="text-lg uppercase font-bolf">{car.name}</h3>
                    ...
                    <div className="flex gap-x-3 xl:gap-x4 w-max mb-10">
                      {car.info.map((item,index)=>{
                        return(
                          <div key={index} className="flex flex-col items-center">
                            <div className="bg-primary w-12 h-12 roundedd-full flex justify-center items-center mb-2">
                              <Image
                              src={item.icon} width={24}height={24} alt=""/>
                            </div>
                    ...
                    <button className="btn btn-accent btn-lg">Show Details</button>
                </div>
              </SwiperSlide>
            )
          })
